...
class Generator(object):
    ...
    def retrieve(self, context, used_templates=None, topk=20, T=1.0, **kwargs):
...
class Templates(object):
    ...
    def from_pickle(cls, path):
        templates = read_pickle(path, encoding="latin1")
