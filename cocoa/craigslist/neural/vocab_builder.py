...
from cocoa.craigslist.neural.symbols import markers, sequence_markers
...
def build_kb_vocab(dialogues, special_symbols=[]):
    ...
    cat_vocab.add_words(
        ["bike", "car", "electronics", "furniture", "housing", "phone"], special=True
    )
    cat_vocab.finish()
...
def create_mappings(dialogues, schema, entity_forms):
    ...
    return {
        "utterance_vocab": utterance_vocab,
        "kb_vocab": kb_vocab,
        "cat_vocab": cat_vocab,
        "lf_vocab": lf_vocab,
    }
