...
def add_dataset_arguments(parser):
    parser.add_argument(
        "--train-examples-paths", nargs="*", default=[], help="Input training examples"
    )
    parser.add_argument(
        "--test-examples-paths", nargs="*", default=[], help="Input test examples"
    )
    parser.add_argument(
        "--train-max-examples", type=int, help="Maximum number of training examples"
    )
    parser.add_argument(
        "--test-max-examples", type=int, help="Maximum number of test examples"
    )
    parser.add_argument(
        "--eval-examples-paths",
        nargs="*",
...
def add_scenario_arguments(parser):
    parser.add_argument(
        "--schema-path", help="Input path that describes the schema of the domain"
    )
    parser.add_argument(
        "--scenarios-path", help="Output path for the scenarios generated"
    )
...
def add_logging_arguments(parser):
    ...
    group.add_argument(
        "--best-only", action="store_true", help="Only store the best checkpoint"
    )
...
def add_trainer_arguments(parser):
    ...
    # Optimization
    group.add_argument(
        "--batch-size", type=int, default=64, help="Maximum batch size for training"
    )
...
def add_rl_arguments(parser):
    ...
    group.add_argument(
        "--max-turns", default=100, type=int, help="Maximum number of turns"
    )
    group.add_argument(
        "--num-dialogues",
        default=10000,
...
def add_generator_arguments(parser):
    ...
    group.add_argument(
        "--min-length", type=int, default=1, help="Minimum prediction length"
    )
    group.add_argument(
        "--max-length", type=int, default=50, help="Maximum prediction length."
    )
    group.add_argument(
        "--n-best",
        type=int,
    ...
    group.add_argument(
        "--sample", action="store_true", help="Sample instead of beam search"
    )
    group.add_argument(
        "--temperature", type=float, default=1, help="""Sample temperature"""
    )
