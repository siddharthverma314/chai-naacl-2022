...
class Translator(object):
    ...
    def translate_batch(self, batch, data):
        ...
        src_map = (
            rvar(batch.src_map.data) if data_type == "text" and self.copy_attn else None
        )
        ...
        for i in range(self.max_length):
            ...
            if not self.copy_attn:
                ...
                out = data.collapse_copy_scores(
                    unbottle(out.data), batch, self.fields["tgt"].vocab, data.src_vocabs
                )
                # beam x tgt_vocab
                out = out.log()
